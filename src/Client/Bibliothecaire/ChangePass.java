...
public class ChangePass extends javax.swing.JDialog {
    ...
    private void jButtonChangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonChangeActionPerformed
        try {
            ...
            Bibliothecaire intermed = MetierServiceFactory.getAdherentService().newBibliothecaire(bibliothecaire.getNom(), bibliothecaire.getPrenom(), bibliothecaire.getLogin(), oldpass, false);
            if(intermed.getMotDePasse().equals(bibliothecaire.getMotDePasse())) {
                if(newpass.equals(confpass)) {
                    if(!newpass.equals(oldpass)) {
                        editBiblio.setMdpEdited(newpass);
                        jLabelStatut.setText("<html><body><font color='green'>Votre demande a été prise en compte</font></body></html>");
                        editBiblio.setStatut("<html><body><font color='orange'>Modification du mot de passe en attente...</font></body></html>");
                        this.dispose();
                    }else{
                ...
                jLabelStatut.setText("<html><body><font color='red'>Ancien mot de passe incorrect</font></body></html>");
            }
        } catch (Exception ex) {
    ...
    public void setIhm(EditBiblio editBiblio) {
        this.editBiblio = editBiblio;
    }
